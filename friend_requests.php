...
if ($numrows == 0) {
 echo "<h3 class='no-requests'>You have no friend Requests at this time</h3>";
 $user_from = "";
}
else
{
...
<input type="submit" class="button" name="acceptrequest<? echo $user_from; ?>" value="Accept Request">
<input type="submit" class="button" name="ignorerequest<? echo $user_from; ?>" value="Ignore Request">
</form>
</div>
</div>
<?php
